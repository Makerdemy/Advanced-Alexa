...
const StartedUserInterestIntentHandler = {
    ...
    handle(handlerInput) {
        ...
        let hobby = handlerInput.requestEnvelope.request.intent.slots.hobbie.value;
...
const sportshobbiesgivenInterestIntentHandler = {
    canHandle(handlerInput) {
        return handlerInput.requestEnvelope.request.type === 'IntentRequest'
            ...
            && handlerInput.requestEnvelope.request.intent.slots.hobbie.value
...
exports.handler = Alexa.SkillBuilders.custom()
    .addRequestHandlers(
        ...
        UserInformationIntentHandler,
        StartedUserInterestIntentHandler,
        sportshobbiesgivenInterestIntentHandler,
        
        CompletedinterestIntentHandler,
        HelpIntentHandler,
